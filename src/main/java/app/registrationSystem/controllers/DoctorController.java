...
import app.registrationSystem.dto.VisitsDTO;
...
public class DoctorController {
    ...
    public ResponseEntity<String> addVisits(@AuthenticationPrincipal CustomUserDetails customUserDetails, @NotNull @RequestBody VisitsDTO visits) {
    ...
    public ResponseEntity<List<ScheduledVisit>> checkScheduledVisits(@AuthenticationPrincipal CustomUserDetails customUserDetails) {
        return ResponseEntity.status(HttpStatus.OK).body(doctorService.checkScheduledVisits(customUserDetails.getUsername()));
    }
